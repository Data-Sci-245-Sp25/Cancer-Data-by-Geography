...
#sig diff btw 102 & 101,105,114 as well as 114 & 103,116

oneWayAnovaBreast <- aov(CancerRatesBreast$rate_per_100k ~ CancerRatesBreast$pumaCode)
summary(oneWayAnovaBreast)
#no sig diff btwn means

oneWayAnovaPancreas <- aov(CancerRatesPancreas$rate_per_100k ~ CancerRatesPancreas$pumaCode)
TukeyHSD(oneWayAnovaPancreas, conf.level = .95)
#anova says sig but pairwise say no sig
```
